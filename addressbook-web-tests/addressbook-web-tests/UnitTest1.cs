...
namespace addressbook_web_tests
{
    ...
    public class UnitTest1
    {
        ...
        {
            Square s1 = new Square(5); // call constructor
            Square s2 = new Square(10); // call constructor
            Square s3 = s1;
        ...
        {
            Circle s1 = new Circle(5); // call constructor
            Circle s2 = new Circle(10); // call constructor
            Circle s3 = s1;
